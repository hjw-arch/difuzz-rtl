...
def _status_header() -> str:
    return "\t".join([
        ...
        "target_handles", "rtl_cycles", "rtl_trace_events",
        "rtl_main_trace_events",
        "target_hits", "target_new",
    ...
    for it in range(int(num_iter)):
        ...
        if status_log:
            ...
            _append_status(status_log, [
                ...
                int(getattr(rtl_host, "last_trace_events", 0) or 0),
                int(getattr(rtl_host, "last_main_trace_events", 0) or 0),
